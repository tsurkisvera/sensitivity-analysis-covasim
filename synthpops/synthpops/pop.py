...
class Pop(sc.prettyobj):
    ...
    def generate(self):
        ...
        # print('Load and store the expected age distribution of the population')
        ...
        #print('Generate an age count for the population')
        ...
        if household_method == 'fixed_ages':
            ...
            homes_dic, homes = sphh.generate_all_households_fixed_ages(n_nonltcf, hh_sizes, hha_by_size, hha_brackets, cm_age_brackets, cm_age_by_brackets, contact_matrices, ages_left_to_assign) # 22/08/24 здесь всё ломается!!
            #print('generate_all_households_fixed_ages is executed')
        ...
        #print('households are generated')
        ...
        workplace_age_lists, workplace_uid_lists, potential_worker_uids, potential_worker_uids_by_age, workers_by_age_to_assign_count = spw.assign_rest_of_workers(workplace_sizes,
                                                                                                                                                                   ...
                                                                                                                                                                   cm_age_by_brackets,
                                                                                                                                                                   contact_matrices)
        #print('workplaces are generated')
